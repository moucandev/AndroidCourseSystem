package com.example.moucan.androidcoursesystem.imageloader.drawable;
...
public class TextDrawable extends Drawable {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        mTextLayout = new StaticLayout(mText, mTextPaint, bounds.width(),
                mTextAlignment, 1.0f, 0.0f, false);
    ...
    public void draw(@NonNull Canvas canvas) {
        if (mTextPath == null) {
            ...
            GravityCompat.apply(Gravity.CENTER,mTextLayout.getWidth(),mTextLayout.getHeight(),getBounds(),outRect, ViewCompat.LAYOUT_DIRECTION_LTR);
