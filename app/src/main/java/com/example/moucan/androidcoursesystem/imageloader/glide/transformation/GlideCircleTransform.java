package com.example.moucan.androidcoursesystem.imageloader.glide.transformation;
...
import com.pwrd.dls.marble.common.util.DrawUtils;
...
public class GlideCircleTransform extends BitmapTransformation {
    ...
    public GlideCircleTransform(Context context, float borderWidth, int borderColor) {
        ...
        mBorderWidth = DrawUtils.dip2px(borderWidth);
